...
db.connect(function (err) {
  ...
  db.query(
    "CREATE DATABASE IF NOT EXISTS sistema_de_vendas",
    function (err, result) {
      if (err) throw err;
  ...
  const usuarios =
    "CREATE TABLE IF NOT EXISTS usuarios (id INT AUTO_INCREMENT, nome_completo VARCHAR(45), login VARCHAR(45), senha VARCHAR(45), email VARCHAR(45), telefone VARCHAR(45), estado VARCHAR(45), cidade VARCHAR(45), link_foto_perfil VARCHAR(45), PRIMARY KEY (id))";
